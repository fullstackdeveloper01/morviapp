                                        ...
                                        <div class="row">
                                            <?php
                                                $images=[
                                                    ...
                                                    ['name'=>'restorant_details_image','help'=>"590x400px",'label'=>__('Morvi Default Image'),'value'=>config('global.restorant_details_image'),'style'=>'width: 200px;'],
                                                    ['name'=>'restorant_details_cover_image','label'=>__('Morvi Details Cover Image'),'value'=>config('global.restorant_details_cover_image'),'style'=>'width: 200px;'],
