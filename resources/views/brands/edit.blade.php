...
@section('content')
    ...
    @include('brands.partials.header', ['title' => __('Edit Brand')])
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <form method="post" action="{{ route('brands.update',$brand) }}" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-5 form-group{{ $errors->has('brand_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="brand_name" id="brand_name" class="form-control form-control-alternative{{ $errors->has('brand_name') ? ' is-invalid' : '' }}" value="{{$brand->brand_name}}" required maxlength="30">
                                    ...
                                    <div class="col-md-3 form-group{{ $errors->has('brand_icon') ? ' has-danger' : '' }}">
                                    ...
                                    @if($brand->brand_icon != '')
                                        ...
                                        <div class="col-md-2 form-group{{ $errors->has('brand_icon') ? ' has-danger' : '' }}">

                                            <label class="form-control-label" for="brand_icon">{{ __('Selected icon') }}</label>

                                            <img src="{{asset('uploads/brand').'/'.$brand->brand_icon}}" onerror="this.onerror=null;this.style.display='none';"style="width: 50%;height: 65%;">
