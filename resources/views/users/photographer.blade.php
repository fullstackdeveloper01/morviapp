                    ...
                    <div class="nav-wrapper">
						...
						<ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
							...
							<li class="nav-item">
								...
								<a class="nav-link mb-sm-3 mb-md-0 active" id="basic-details-tab" data-toggle="tab" href="#basic-details" role="tab" aria-controls="basic-details" aria-selected="true"><i class="ni ni-bullet-list-67 mr-2"></i>{{ __ ('Basic Details') }}</a>
