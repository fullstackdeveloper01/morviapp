@extends('layouts.app', ['title' => __('Sub Categories')])
                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                <a href="{{ route('subCategory.create') }}" class="btn btn-sm btn-primary">{{ __('Add Category') }}</a>
                                ...
                                @foreach ($categoryList as $key => $category)
                                    ...
                                    <tr>
                                        ...
                                        <td data-sort="{{ strtotime($category->created_at )}}">
                                            <a class="btn badge badge-success badge-pill" href="{{ route('subCategory.edit', $category) }}">#{{ $key+1 }}</a>
                                        </td>
                                        ...
                                        <td><a class="btn badge badge-success badge-pill" href="{{ route('subCategory.edit', $category) }}">{{ $category->category_name }}</a></td>
                                        ...
                                        <td class="text-right d-flex align-items-right">
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('subCategory.edit', $category) }}"><i class="fa fa-edit"></i> {{__('Edit') }}</a>
