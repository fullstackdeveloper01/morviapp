...
@section('content')
    ...
    @include('category.partials.header', ['title' => __('Add Sub Category')])
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <form method="post" action="{{ route('subCategory.store') }}" enctype="multipart/form-data" autocomplete="off">
                                ...
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-5 form-group{{ $errors->has('category_name') ? ' has-danger' : '' }}">
                                            ...
                                            <label class="form-control-label" for="category_name">{{ __('Sub Category Name') }}</label>
