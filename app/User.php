...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'phone', 'google_id', 'apple_id', 'api_token', 'bc_id', 'birth_date', 'working', 'lat', 'lng', 'numorders', 'rejectedorders', 'place', 'business_name', 'about_business', 'document_type', 'attached_document', 'experience', 'otp', 'role','device_id'
    ];
    ...
    public function city(){
        return $this->belongsTo('App\City', 'place');
    }
}
