...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::name('admin.')->group(function () {
        ...
        Route::post('sendEmailToUser', 'UserController@sendEmailToUser')->name('user.sendEmailToUser');
    ...
    Route::get('advertisementList/{udi}', 'MonitorController@advertisementList')->name('monitor.advertisementList');
    Route::get('approveDisapproveAdvertisement/{id}/{status}', 'MonitorController@approveDisapproveAdvertisement')->name('reports.approveDisapproveAdvertisement');
    Route::resource('brands', 'BrandsController');
    Route::resource('state', 'StateController');
    Route::resource('city', 'CityController');
    Route::resource('category', 'CategoryController');
    Route::get('/getSubCategory/{id}', 'CategoryController@getSubCategory')->name('category.getSubCategory');
    Route::resource('subCategory', 'SubCategoryController');
    Route::resource('tableColumn', 'TableColumnController');
    Route::get('reports/{id}', 'ReportsController@professionalUser')->name('reports.professionalUser');
    Route::get('professionalList/{uid}/{id}', 'ReportsController@professionalList')->name('reports.professionalList');
    Route::get('changeTableRowStatus/{id}/{status}', 'ReportsController@changeTableRowStatus')->name('reports.changeTableRowStatus');
	/* //End immersive */
...
// Feeds section route and url

Route::get('/feeds', 'FeedController@index')->name('feeds.index');

Route::get('feeds/{id}/edit', 'FeedController@edit')->name('feeds.edit');

Route::put('feeds/{id}', 'FeedController@update')->name('feeds.update');

Route::get('feeds/{id}', 'FeedController@delete')->name('feeds.delete');

Route::post('feeds-status', 'FeedController@updateStatus');

Route::get('feeds/{id}/view', 'FeedController@viewFeedDetails')->name('feeds.view');
